...
const AdminCampaignPage = () => {
    ...
    const handleSubmit = () => {
        ...
        //'campaign_id'
        //`merchant" bson:"merchant" example:"7-11"`
        //`card_type" bson:"card_type" example:"super_miles_card"`
        //`description" bson:"description"`
        //`start_date" bson:"start_date"`
        //`end_date" bson:"end_date"`
        //`min_spend" bson:"min_spend" example:"100.0"`
        //`bonus_rates" bson:"bonus_rates" example:"8.8"`
        //`accepted_mccs" bson:"accepted_mccs"`
    ...
    const createCampaign = async () => {
        try {
            const res = await api.post(`/api/v1/campaign`, {
                campaigns: [{
                    campaign_id: "cmp00001",
                    merchant: merchantName,
                    card_type: cardType,
                    accepted_mccs: [0, 1, 2],
                    bonus_rates: 0.01,
                    min_spend: parseFloat(minSpend),
                    start_date: "2025-01-02 15:04",
                    end_date: "2025-01-02 20:04",
                    description: "",
                }]
            })
        }
